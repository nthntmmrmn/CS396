...
def main():
    ...
    # lat=df_AZ[df_AZ['city']=='Arizona']['latitude']
    # lon=df_AZ[df_AZ['city']=='Arizona']['longitude']
    # print(lat,lon)
    # print(df_AZ[df_AZ['city']=='Arizona']['name'])
    ...
    #       (verified that no cities in original set started with wrong letter)
...
def getCityFromLatAndLong(lat,lon):
    print(gmaps.reverse_geocode((lat, lon))[0]['address_components'][2]['long_name'])
